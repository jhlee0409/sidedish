            ...
            <div className="flex -space-x-4 items-center px-6 py-3 bg-white/60 backdrop-blur-sm rounded-full border border-white/50">
               {[1,2,3,4].map(i => (
                 <div key={i} className="w-8 h-8 rounded-full border-2 border-white bg-slate-200 flex items-center justify-center text-[10px] font-bold text-slate-500 overflow-hidden">
                   <img src={`https://picsum.photos/seed/${i * 123}/100/100`} alt="user" className="w-full h-full object-cover" />
                 </div>
               ))}
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(300px,auto)]">
            ...
            <div className="md:col-span-2 bg-[#F8FAFC] rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden group hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500 border border-slate-100">
                ...
                <div className="absolute right-[-20px] bottom-[-40px] md:right-[-50px] md:bottom-[-50px] w-80 md:w-96 shadow-2xl rounded-xl overflow-hidden border-4 border-white/50 rotate-[-6deg] group-hover:rotate-0 group-hover:scale-105 transition-all duration-500">
                    <img src="https://images.unsplash.com/photo-1664575602276-acd073f104c1?auto=format&fit=crop&q=80&w=800" alt="AI Writing UI" className="w-full" />
                </div>
            </div>
                  ...
                  <div className="order-2 md:order-1 relative">
                      ...
                      <div className="relative bg-white p-6 rounded-3xl shadow-xl border border-slate-100 rotate-[-2deg] hover:rotate-0 transition-transform duration-500">
                          ...
                          <div className="aspect-[4/3] bg-slate-100 rounded-xl mb-4 overflow-hidden relative">
                              <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover" alt="Project" />
