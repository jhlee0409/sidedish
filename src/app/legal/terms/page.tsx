      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <article className="prose prose-slate max-w-none">
          ...
          <section className="mt-8">
            ...
            <p>
              이 약관은 SideDish(이하 &quot;회사&quot;)가 제공하는 사이드 프로젝트 공유 플랫폼 서비스(이하 &quot;서비스&quot;)의
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              <li>
                <strong>&quot;서비스&quot;</strong>란 회사가 제공하는 사이드 프로젝트 등록, 공유, 소통 관련
                일체의 서비스를 의미합니다.
              </li>
              <li>
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              ...
              <li>
                회사가 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 적용일자 7일 전부터
          ...
          <section className="mt-12">
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              <li>
                ...
                소셜 로그인(Google, GitHub)을 통해 가입신청을 하고, 회사가 이를 승낙함으로써 체결됩니다.
              </li>
              <li>
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              <li>
                회사는 전조의 규정에 의한 가입신청에 대하여 특별한 사유가 없는 한 접수순서대로 이용신청을 승낙합니다.
              </li>
              <li>
                ...
                <ul className="list-disc pl-6 mt-2">
                  ...
                  <li>이전에 회원자격을 상실한 적이 있는 경우 (단, 자격 상실 후 1년이 경과한 자로서 회사의 재가입 승낙을 얻은 경우 예외)</li>
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              ...
              <li>
                회원은 가입신청 시 기재한 사항이 변경되었을 경우 즉시 회원정보를 수정해야 하며, 수정하지 않아 발생한 불이익에 대해 회사는 책임지지 않습니다.
              </li>
            </ol>
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              <li>
                회원은 언제든지 마이페이지에서 회원 탈퇴를 신청할 수 있으며, 회사는 즉시 회원탈퇴를 처리합니다.
              </li>
              <li>
              ...
              <li>
                ...
                <ul className="list-disc pl-6 mt-2">
                  ...
                  <li>기타 회사가 합리적인 판단에 기하여 서비스 제공을 거절할 필요가 있다고 인정하는 경우</li>
                </ul>
              </li>
              <li>
          ...
          <section className="mt-12">
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              ...
              <li>
                서비스는 연중무휴, 1일 24시간 제공함을 원칙으로 합니다. 다만, 회사의 업무상 또는 기술상의 이유로
                서비스가 일시 중지될 수 있으며, 운영상의 목적으로 회사가 정한 기간에는 서비스가 일시 중지될 수 있습니다.
              </li>
            </ol>
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              <li>
                회사는 Google Gemini AI를 활용하여 회원이 입력한 프로젝트 초안을 기반으로 프로젝트 설명을 자동 생성하는
                서비스를 제공합니다.
              </li>
              <li>
              ...
              <li>
                AI가 생성한 콘텐츠의 정확성, 완전성, 적합성에 대해 회사는 보증하지 않으며, 회원은 생성된 콘텐츠를
          ...
          <section className="mt-12">
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              ...
              <li>
                회원이 등록한 콘텐츠에 대한 저작권 및 지적재산권은 해당 회원에게 귀속됩니다. 다만, 회사는 서비스의 운영,
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              ...
              <li>
                회원은 서비스를 이용함으로써 얻은 정보를 회사의 사전 승낙 없이 복제, 전송, 출판, 배포, 방송 기타 방법에
                의하여 영리목적으로 이용하거나 제3자에게 이용하게 하여서는 안 됩니다.
              </li>
              <li>
                회원이 서비스 내에 게시한 콘텐츠의 저작권은 해당 회원에게 귀속됩니다. 다만, 회원은 서비스 이용을 위하여
                필요한 범위 내에서 회사에게 해당 콘텐츠를 사용, 복제, 수정, 배포할 수 있는 권리를 부여합니다.
              </li>
            </ol>
          </section>
          ...
          <section className="mt-12">
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              ...
              <li>
                회사는 서비스 이용과 관련하여 회원으로부터 제기된 의견이나 불만이 정당하다고 인정될 경우 이를 처리하여야 합니다.
              </li>
            </ol>
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              ...
              <li>
                회원은 관련 법령, 이 약관의 규정, 이용안내 및 서비스와 관련하여 공지한 주의사항, 회사가 통지하는 사항 등을
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              ...
              <li>
                회원은 자신의 계정이 부정하게 사용된 것을 발견한 경우 즉시 회사에 통보해야 합니다.
              </li>
              <li>
                계정의 부정 사용으로 인해 발생한 손해에 대해 회사는 책임지지 않습니다.
              </li>
            </ol>
          </section>
          ...
          <section className="mt-12">
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              ...
              <li>
                회원이 이 약관을 위반하여 회사에 손해를 입힌 경우 해당 회원은 회사에 그 손해를 배상해야 합니다.
              </li>
            </ol>
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              ...
              <li>
                회사는 회원이 게시 또는 전송한 콘텐츠의 내용에 대해서는 책임을 지지 않습니다.
              </li>
              <li>
              ...
              <li>
                회사는 AI 콘텐츠 생성 서비스로 생성된 결과물의 정확성, 신뢰성, 적법성에 대해 보증하지 않으며,
