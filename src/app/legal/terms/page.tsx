        ...
        <article className="prose prose-slate max-w-none">
          ...
          <section className="mt-12">
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              ...
              <li>
                탈퇴 후 30일 이내에는 동일한 소셜 계정으로 로그인 시 계정을 복구할 수 있습니다.
                복구 시 프로필을 다시 설정해야 하며, 30일이 경과하면 계정 복구가 불가능합니다.
              </li>
            </ol>
          </section>
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-2">
              ...
              <li>
                ...
                <ul className="list-disc pl-6 mt-2">
                  ...
                  <li>회원당 24시간당 최대 3회의 홍보 요청이 가능합니다.</li>
                  <li>동일 프로젝트는 7일 이후에 다시 홍보할 수 있습니다.</li>
