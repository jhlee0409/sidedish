  ...
  describe('valid submissions', () => {
    ...
    it('should accept full valid project', () => {
      const validProject = {
        ...
        links: [
          { id: 'link-1', storeType: 'WEB', url: 'https://example.com/project', label: '', isPrimary: true },
          { id: 'link-2', storeType: 'GITHUB', url: 'https://github.com/user/project', label: '', isPrimary: false },
        ],
        platform: 'WEB',
        isBeta: true,
      }
