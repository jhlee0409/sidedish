    ...
    >
      ...
      <div className="relative aspect-[16/10] overflow-hidden bg-slate-100">
        ...
        <div className="absolute top-3 left-3 flex items-center gap-1.5">
          <div className="bg-white/90 backdrop-blur-md px-2 py-1 rounded-lg text-slate-700 text-[11px] font-semibold flex items-center gap-1 shadow-sm border border-white/50">
            <span className="text-slate-500">{badge.icon}</span>
            <span>{badge.label}</span>
          </div>
          {project.isBeta && (
            <div className="bg-amber-500 px-1.5 py-1 rounded-lg text-white text-[10px] font-bold flex items-center gap-0.5 shadow-sm">
      ...
      {/* Content */}
      <div className="p-4">
        <h3 className="text-[15px] font-bold text-slate-900 leading-snug group-hover:text-orange-600 transition-colors line-clamp-1 mb-1.5">
          {project.title}
        </h3>
